...
@Dependent public class MarshallerFactoryImpl implements MarshallerFactory {
  ...
  abstract class Marshaller_for_com_example_client_shared_Response implements GeneratedMarshaller { }
  abstract class Marshaller_for_org_jboss_errai_jpa_sync_client_shared_DeleteResponse implements GeneratedMarshaller { }
  abstract class Marshaller_for_com_example_client_shared_HelloMessage implements GeneratedMarshaller { }
  ...
  public Marshaller getMarshaller(String a0) {
    ...
    } else if (a0.equals("org.jboss.errai.jpa.sync.client.shared.UpdateResponse")) {
      m = GWT.create(Marshaller_for_org_jboss_errai_jpa_sync_client_shared_UpdateResponse.class);
    } else if (a0.equals("org.jboss.errai.jpa.sync.client.shared.NewRemoteEntityResponse")) {
      m = GWT.create(Marshaller_for_org_jboss_errai_jpa_sync_client_shared_NewRemoteEntityResponse.class);
    } else if (a0.equals("org.jboss.errai.jpa.sync.client.shared.SyncRequestOperation$Type")) {
      m = GWT.create(Marshaller_for_org_jboss_errai_jpa_sync_client_shared_SyncRequestOperation_erraiD_Type.class);
    } else if (a0.equals("com.example.client.shared.Response")) {
      m = GWT.create(Marshaller_for_com_example_client_shared_Response.class);
    } else if (a0.equals("org.jboss.errai.jpa.sync.client.shared.DeleteResponse")) {
      m = GWT.create(Marshaller_for_org_jboss_errai_jpa_sync_client_shared_DeleteResponse.class);
    } else if (a0.equals("com.example.client.shared.HelloMessage")) {
      m = GWT.create(Marshaller_for_com_example_client_shared_HelloMessage.class);
    } else if (a0.equals("org.jboss.errai.jpa.sync.client.shared.ConflictResponse")) {
      m = GWT.create(Marshaller_for_org_jboss_errai_jpa_sync_client_shared_ConflictResponse.class);
    } else if (a0.equals("org.jboss.errai.jpa.sync.client.shared.SyncRequestOperation")) {
    ...
    } else if (a0.equals("org.jboss.errai.jpa.sync.client.shared.SyncableDataSet")) {
      m = GWT.create(Marshaller_for_org_jboss_errai_jpa_sync_client_shared_SyncableDataSet.class);
    } else if (a0.equals("org.jboss.errai.jpa.sync.client.shared.IdChangeResponse")) {

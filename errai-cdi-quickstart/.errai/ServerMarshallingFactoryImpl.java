...
@Dependent public class ServerMarshallingFactoryImpl implements MarshallerFactory {
  ...
  @Inject @ObserverModel private Event<Response> var3;
  @Inject @ObserverModel private Event<HelloMessage> var4;
  ...
  private Marshaller<Response> com_example_client_shared_Response;
  private Marshaller<HelloMessage> com_example_client_shared_HelloMessage;
  ...
  public ServerMarshallingFactoryImpl() {
    ...
    com_example_client_shared_Response = new Marshaller<Response>() {
      ...
      public Response demarshall(EJValue a0, MarshallingSession a1) {
        try {
          ...
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: com.example.client.shared.Response", t);
        }
      }
      public String marshall(Response a0, MarshallingSession a1) {
        ...
        if (a1.hasObject(a0)) {
          String objId = a1.getObject(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"com.example.client.shared.Response\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObject(a0);
        a1.recordObject(objId, objId);
        return new StringBuilder(384).append("{\"^EncodedType\":\"com.example.client.shared.Response\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"id\" : ").append(java_lang_Integer.marshall(a0.getId(), a1)).append(",").append("\"message\" : ").append(java_lang_String.marshall(a0.getMessage(), a1)).append("}").toString();
      }
    };
    marshallers.put("com.example.client.shared.Response", com_example_client_shared_Response);
    com_example_client_shared_HelloMessage = new Marshaller<HelloMessage>() {
      ...
      public HelloMessage demarshall(EJValue a0, MarshallingSession a1) {
        try {
          ...
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: com.example.client.shared.HelloMessage", t);
        }
      }
      public String marshall(HelloMessage a0, MarshallingSession a1) {
        ...
        if (a1.hasObject(a0)) {
          String objId = a1.getObject(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"com.example.client.shared.HelloMessage\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObject(a0);
        a1.recordObject(objId, objId);
        return new StringBuilder(384).append("{\"^EncodedType\":\"com.example.client.shared.HelloMessage\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"id\" : ").append(java_lang_Integer.marshall(a0.getId(), a1)).append(",").append("\"message\" : ").append(java_lang_String.marshall(a0.getMessage(), a1)).append("}").toString();
      }
    };
    marshallers.put("com.example.client.shared.HelloMessage", com_example_client_shared_HelloMessage);
  ...
  private static String _1630335596__1195259493_detailMessage(Throwable instance) {
    try {
      return (String) _1630335596__1195259493_detailMessage_fld.get(instance);
    } catch (Throwable e) {
      e.printStackTrace();
      throw new RuntimeException(e);
    }
  ...
  private static void _1630335596__1195259493_detailMessage(Throwable instance, String value) {
    try {
      _1630335596__1195259493_detailMessage_fld.set(instance, value);
    } catch (Throwable e) {
      e.printStackTrace();
      throw new RuntimeException(e);
    }
